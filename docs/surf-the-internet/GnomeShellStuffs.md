...
在主题的网页，我找到他的问题反应页面，也就是github的issues。在这里，我看到了20天前的一条新的issues，描述的问题和我的基本一致，在这条issues下面，有主题作者回复的: 对于使用了较新的gnome版本的app(使用了libadwaita)，有一个暂时的解决方案
...
- 我觉得现在的dock太丑，于是我下载了dash to dock这个插件，并调整到我满意为止
